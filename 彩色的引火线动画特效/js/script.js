/*
* File Name / sparkler.js
* Created Date / Aug 16, 2020
  ...
  window.addEventListener('load', function () {
    ...
    ********************/
    ...
    for (var i = 0; i < fireBallNum; i++) {
      var f = new FireBall(ctx, X / 2, Y / 2);
      fireBalls.push(f);
    }
